...
public class SecurePreferences {
	...
	private static final String PASSWORD = "Mingi Parool";
	...
	public void putStringSet(String key, JSONArray values) {
		JSONSharedPreferences.saveJSONArray(preferences, key, values);
	}
