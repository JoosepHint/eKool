...
import android.content.SharedPreferences;
    ...
    public class JSONSharedPreferences {
      private static final String PREFIX = "json";
        ...
        public static void replaceItem(SharedPreferences prefs,String key, String replacer){
            SharedPreferences.Editor editor = prefs.edit();
            String replacable = prefs.getString(JSONSharedPreferences.PREFIX+key, "");
            replacable = replacable.replace(/*"&quot;"+*/replacer/*+"&quot;"*/, "");
            replacable = replacable.replaceAll("&quot;", "");
            editor.putString(JSONSharedPreferences.PREFIX+key, replacable);
            editor.commit();
        }
